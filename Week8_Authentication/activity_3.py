...
Template has been copied from activity_3.py in Week6_Flask2
...
api = Api(app,
          ...
          authorizations = authorizations)  # Documentation Description
...
class Authenticate(Resource):
    def get(self):
        username="admin"
        password ="admin"
        return  encryptToken(username,password).decode()
